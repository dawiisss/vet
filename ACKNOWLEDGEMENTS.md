...
Vet is built on top of several open-source libraries and frameworks. We would like to thank and acknowledge the authors and maintainers of these projects.

Below is a list of the primary third-party dependencies used in Vet, along with their respective licenses:
...
| `@xterm/addon-ligatures` | 0.10.0 | MIT | [Link](https://github.com/xtermjs/xterm.js/tree/master/addons/addon-ligatures) |
| `@xterm/addon-search` | 0.16.0 | MIT | [Link](https://github.com/xtermjs/xterm.js/tree/master/addons/addon-search) |
| `@xterm/addon-serialize` | 0.14.0 | MIT | [Link](https://github.com/xtermjs/xterm.js/tree/master/addons/addon-serialize) |
| `@xterm/addon-unicode11` | 0.9.0 | MIT | [Link](https://github.com/xtermjs/xterm.js/tree/master/addons/addon-unicode11) |
...
| `globals` | 16.5.0 | MIT | [Link](sindresorhus/globals) |
| `jest` | 30.4.2 | MIT | [Link](https://jestjs.io/) |
| `jest-environment-jsdom` | 30.4.1 | MIT | [Link](https://github.com/jestjs/jest.git) |
...
*Note: This file is automatically compiled from the project's package dependencies. Individual license notices and terms for each library can be found within their respective packages in the `node_modules` directory.*
