...
describe('buildShortcutString', () => {
  ...
  it('normalizes single key without modifiers', () => {
    // Arrange
    const event = { key: 'A', ctrlKey: false, altKey: false, shiftKey: false, metaKey: false } as KeyboardEvent
  ...
  it('includes ctrl modifier', () => {
    // Arrange
    const event = { key: 'c', ctrlKey: true, altKey: false, shiftKey: false, metaKey: false } as KeyboardEvent
  ...
  it('includes all modifiers in the correct order: ctrl+alt+shift+meta+key', () => {
    // Arrange
    const event = { key: 't', ctrlKey: true, altKey: true, shiftKey: true, metaKey: true } as KeyboardEvent
  ...
  it('handles other combinations of modifiers correctly', () => {
    // Arrange
    const ctrlShiftEvent = { key: 'p', ctrlKey: true, altKey: false, shiftKey: true, metaKey: false } as KeyboardEvent
    const metaAltEvent = { key: 'Delete', ctrlKey: false, altKey: true, shiftKey: false, metaKey: true } as KeyboardEvent
