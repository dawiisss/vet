...
const terminalApi = {
  ...
  getTerminalInfo: jest.fn(() => Promise.resolve({ title: 'projects : bash', cwd: '/home/user/projects' })),
...
export function setupMockedApis() {
  ...
  Object.defineProperty(window, 'configApi', { value: configApi, configurable: true })
  Object.defineProperty(window, 'historyApi', { value: historyApi, configurable: true })
  Object.defineProperty(window, 'workspaceApi', { value: workspaceApi, configurable: true })
