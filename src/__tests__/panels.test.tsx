...
describe("panel components", () => {
  ...
  describe("SystemMonitorPanel", () => {
    it("renders without error", async () => {
      ...
      (sysinfoApi.onUpdate as any).mockImplementation((cb: (data: any) => void) => {
        updateCb = cb;
        return () => {
          updateCb = null;
        };
      ...
      const SystemMonitorPanel =
        require("../renderer/src/shared/components/SystemMonitorPanel").default;
  ...
  describe("PortMonitorPanel", () => {
    it("renders without error", async () => {
      ...
      const PortMonitorPanel =
        require("../renderer/src/shared/components/PortMonitorPanel").default;
  ...
  describe("HistoryPanel", () => {
    it("renders without error", async () => {
      ...
      const HistoryPanel =
        require("../renderer/src/shared/components/HistoryPanel").default;
  ...
  describe("WorkspacePanel", () => {
    it("renders without error", async () => {
      ...
      terminalApi.getTerminalInfo.mockReturnValue(
        new Promise((resolve) => {
          getTerminalInfoResolve = resolve;
        }),
      );

      let listDirResolve: any;
      workspaceApi.listDir.mockReturnValue(
        new Promise((resolve) => {
          listDirResolve = resolve;
        }),
      );
  ...
  describe("ConnectionsPanel", () => {
    it("renders without error", async () => {
      const ConnectionsPanel =
        require("../renderer/src/features/connections/components/ConnectionsPanel").default;
      jest
        .spyOn(connectionsApi, "getSshHosts")
        .mockResolvedValue([]);
      jest
        .spyOn(connectionsApi, "getDockerContainers")
        .mockResolvedValue([]);
