...
const AVAILABLE_ACTIONS = [
  ...
  {
    id: "tabbar:toggle-position",
    label: "Toggle Tab Bar Position (Top/Left/Right)",
  },
  ...
  return (
    ...
    >
      {recordingAction && (
        ...
        >
          <h3 style={{ margin: 0, color: "var(--app-fg)" }}>
            Recording Keybinding
          </h3>
          <p style={{ margin: 0, color: "#bac2de", fontSize: 13 }}>
            Press the new key combination for{" "}
            <strong>
              {AVAILABLE_ACTIONS.find((a) => a.id === recordingAction)?.label}
            </strong>
            .
          </p>
          <p style={{ margin: 0, color: "var(--app-red)", fontSize: 12 }}>
            Press ESC to cancel.
          </p>
        </div>
      )}
      ...
      {AVAILABLE_ACTIONS.map((action) => {
        ...
        return (
          ...
          >
            <span style={{ color: "var(--app-fg)", fontSize: 14 }}>
              {action.label}
            </span>
