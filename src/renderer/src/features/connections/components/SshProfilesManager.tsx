...
const isSshHost = (
  h: SshHost | { name: string; command: string },
): h is SshHost => "host" in h;
  ...
  const saveHost = () => {
    ...
    if (isEditingNew) {
      ...
      updated = updated.map((h) =>
        h.id === selectedId ? { id: h.id, ...hostData } : h,
      );
      updateConfig({ sshHosts: updated });
    }
  };
    ...
    <div style={{ display: "flex", gap: 16, height: 350 }}>
      ...
      >
        <div style={{ display: "flex", gap: 12 }}>
          ...
          >
            <label style={{ fontSize: 12, color: "#bac2de" }}>
              Profile Name
            </label>
            <input
              type="text"
        ...
        <div style={{ display: "flex", gap: 12, marginTop: 8 }}>
          ...
          >
            <input
              ...
              name="authType"
              value="password"
              checked={editAuthType === "password"}
              onChange={() => setEditAuthType("password")}
            />{" "}
            Password
          </label>
          <label
          ...
          >
            <input
              ...
              name="authType"
              value="key"
              checked={editAuthType === "key"}
              onChange={() => setEditAuthType("key")}
            />{" "}
            Private Key
          </label>
          <label
          ...
          >
            <input
              ...
              name="authType"
              value="agent"
              checked={editAuthType === "agent"}
              onChange={() => setEditAuthType("agent")}
            />{" "}
            SSH Agent
          </label>
        </div>
